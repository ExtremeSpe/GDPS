...
$string['possibleLevelsSpamming'] = 'Możliwy spam poziomami';
$string['disableLevelsUploading'] = 'Wyłącz wysyłanie poziomów';
$string['possibleAccountsSpamming'] = 'Możliwy spam kontami';
$string['disableAccountsRegistering'] = 'Wyłącz rejestrowanie kont';
$string['possibleCommentsSpamming'] = 'Możliwy spam komentarzami';
$string['disableComments'] = 'Wyłącz komentowanie';
$string['similarCommentsCount'] = 'Podobna ilość komentarzy';
$string['similarityValueOfAllComments'] = 'Wartość podobieństwa spośród wszystkich komentarzy';
$string['possibleCommentsSpammer'] = 'Możliwy spammer komentarzami';
$string['banCommenting'] = 'Zbanuj komentowanie';
$string['spammerUsername'] = 'Nazwa spammera';
$string['possibleAccountPostsSpamming'] = 'Możliwy spam postami';
$string['disablePosting'] = 'Wyłącz postowanie';
$string['similarPostsCount'] = 'Podobna ilość postów';
$string['similarityValueOfAllPosts'] = 'Wartość podobieństwa spośród wszystkich postów';
$string['possibleAccountPostsSpammer'] = 'Możliwy spammer postami';
$string['possibleRepliesSpamming'] = 'Możliwy spam odpowiedziami';
$string['possibleRepliesSpammer'] = 'Możliwy spammer odpowiedziami';
$string['similarRepliesCount'] = 'Podobna ilość odpowiedzi';
$string['similarityValueOfAllReplies'] = 'Wartość podobieństwa spośród wszystkich odpowiedzi';
$string['unknownWarning'] = 'Nieznane ostrzeżenie';
$string['before'] = 'Przed';
$string['after'] = 'Po';
$string['compare'] = 'Porównaj';
$string['resolvedWarning'] = 'Rozwiązano ostrzeżenie';
$string['resolveWarning'] = 'Rozwiąż ostrzeżenie';
$string['enabled'] = 'Włączone';
$string['disabled'] = 'Wyłączone';
$string['yesterday'] = 'Wczoraj';
$string['today'] = 'Dzisiaj';
$string['uploading'] = 'Wysyłanie';
$string['commenting'] = 'Komentowanie';
$string['leaderboardSubmits'] = 'Przesłania leaderboardów';
$string['manageLevels'] = 'Zarządzaj poziomami';
$string['disableLevelsUploading'] = 'Wyłącz wysyłanie poziomów';
$string['disableLevelsCommenting'] = 'Wyłącz komentowanie poziomów';
$string['disableLevelsLeaderboardSubmits'] = Wyłącz przesłania leaderboardów w poziomach';
$string['disable'] = 'Wyłącz';
$string['enable'] = 'Włącz';
$string['registering'] = 'Rejestrowanie';
$string['accountPosting'] = 'Tworzenie postów';
$string['updatingProfileStats'] = 'Aktualizowanie statytyk profilu';
$string['messaging'] = 'Wysyłanie wiadomości';
$string['manageAccounts'] = 'Zarządzaj kontami';
$string['disableAccountsRegistering'] = 'Wyłącz rejestrowanie nowych kont';
$string['disableAccountPosting'] = 'Wyłącz tworzenie postów';
$string['disableUpdatingProfileStats'] = 'Wyłącz aktualizowanie statystyk profilu';
$string['disableMessaging'] = 'Wyłącz wysyłanie wiadomości';

$string['cantPostCommentsAboveChars'] = 'Nie możesz komentować powyżej %1$s znaków!';
$string['replyingIsDisabled'] = 'Odpowiadanie na komentarze jest teraz wyłączone!';
$string['youAreBannedFromCommenting'] = 'Jesteś zbanowany(na) na komentowanie!';
$string['cantPostAccountCommentsAboveChars'] = 'You cannot post account comments above %1$s characters!';
$string['commentingIsDisabled'] = 'Komentowanie jest teraz wyłączone!';
$string['noWarnings'] = 'Brak ostrzeżeń';
$string['messagingIsDisabled'] = 'Docelowe wiadomości są teraz wyłączone!';

$string['downloadLevelAsGMD'] = 'Zapisz jako .gmd';

$string['songIsAvailable'] = 'Dostępna';
$string['songIsDisabled'] = 'Niedostępna';
$string['disabledSongs'] = 'Wyłączone piosenki';
$string['disabledSFXs'] = 'Wyłączone SFXy';

$string['vaultCodesTitle'] = 'Dodaj kod vaulta';
$string['vaultCodeExists'] = 'Kod z taką nazwą już istnieje!';
$string['reward'] = 'Nagroda';
$string['vaultCodePickOption'] = 'Wybierz typ nagrody';
$string['vaultCodesCreate'] = 'Stwórz kod';
$string['createNewVaultCode'] = 'Stwórz nowy kod!';
$string['vaultCodesDesc'] = 'Możesz tutaj stworzyć nowy kod!';
$string['vaultCodesEditTitle'] = 'Zmień kod vaulta';
$string['vaultCodesEditDesc'] = 'Możesz tutaj zmienić istniejący kod!';
$string['vaultCodeName'] = 'Kod';
$string['vaultCodeUses'] = 'Liczba użyć (0 dla nieskończonej liczby użyć)';
$string['editRewards'] = 'Zmień nagrody';
$string['rewards'] = 'Nagrody';

$string['alsoBanIP'] = 'Również zbanuj na IP';
